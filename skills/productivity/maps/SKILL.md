...
- If you invoke the script manually, prefer the category-qualified path
  `~/.hermes/skills/productivity/maps/scripts/maps_client.py`; older
  examples without the category segment may fail on categorized installs
